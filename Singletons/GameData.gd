...
#-------------- Level 5  Wave ----------------------------------------------
	"Level5":{
		"1":[
			["EColi", 1.7, 30.0, 30.0, 1], # [name, next_spawn_time, hp,
											# movement_speed, track]
			["EColi", 1.7, 30.0, 30.0, 1],
			["EColi", 1.7, 30.0, 30.0, 1],
			["EColi", 1.7, 30.0, 30.0, 1],
			["EColi", 0.8, 30.0, 30.0, 1]
			],
		"2":[
			["EColi", 1.7, 40.0, 30.0, 2], # [name, next_spawn_time, hp,
											# movement_speed, track]
			["EColi", 1.7, 40.0, 30.0, 2],
			["EColi", 1.7, 40.0, 30.0, 2],
			["EColi", 1.7, 40.0, 30.0, 2],
			["EColi", 1.7, 40.0, 30.0, 2]
			],
		"3":[
			["EColi", 1.7, 50.0, 30.0, 3], # [name, next_spawn_time, hp,
											# movement_speed, track]
			["EColi", 1.7, 50.0, 30.0, 3],
			["EColi", 1.7, 50.0, 30.0, 3],
			["EColi", 1.7, 50.0, 30.0, 3],
			["EColi", 1.7, 50.0, 30.0, 3],
			],
		"4":[
			["Coronavirus",1.0, 70.0, 31.0, 1], # [name, next_spawn_time, hp,
											# movement_speed, track]
			["Coronavirus",1.0, 70.0, 31.0, 2],
			["Coronavirus",0.6, 70.0, 31.0, 3],
			["Coronavirus",1.0, 70.0, 31.0, 1],
			["Coronavirus",1.0, 70.0, 31.0, 2],
			["Coronavirus",0.6, 70.0, 31.0, 3],
			["Coronavirus",1.0, 70.0, 31.0, 1],
			["Coronavirus",1.0, 70.0, 31.0, 2],
			["Coronavirus",1.0, 70.0, 31.0, 3],
			["Influenzavirus",1.0, 90.0, 31.0, 1],
			["Influenzavirus",0.8, 90.0, 31.0, 2]
			],
		"5":[
			["Salmonella",0.1, 70.0, 40.0, 1], # [name, next_spawn_time, hp,
											# movement_speed, track]
			["Salmonella",0.1, 70.0, 40.0, 2],
			["Salmonella",0.8, 70.0, 40.0, 3],
			["Salmonella",0.1, 70.0, 40.0, 1],
			["Salmonella",0.1, 70.0, 40.0, 2],
			["Salmonella",1.0, 70.0, 40.0, 3],
			["Influenzavirus",3.0, 90.0, 30.0, 2],
			["Influenzavirus",0.8, 90.0, 30.0, 2]
			],
		"6":[
			["Coronavirus",0.1, 70.0, 31.0, 1], # [name, next_spawn_time, hp,
											# movement_speed, track]
			["Coronavirus",0.1, 70.0, 31.0, 2],
			["Coronavirus",0.8, 70.0, 31.0, 3],
			["Coronavirus",0.1, 70.0, 31.0, 1],
			["Coronavirus",0.1, 70.0, 31.0, 2],
			["Coronavirus",0.8, 70.0, 31.0, 3],
			["Coronavirus",0.1, 70.0, 31.0, 1],
			["Salmonella",0.1, 65.0, 40.0, 2],
			["Salmonella",0.8, 65.0, 40.0, 3],
			["Salmonella",0.1, 65.0, 40.0, 1],
			["Salmonella",0.1, 65.0, 40.0, 2],
			["Salmonella",1.0, 65.0, 40.0, 3],
			["Influenzavirus",0.1, 90.0, 29.0, 1],
			["Influenzavirus",0.1, 90.0, 29.0, 2],
			["Influenzavirus",2.0, 90.0, 29.0, 3],
			["Influenzavirus",0.8, 90.0, 29.0, 1]
			],
		"7":[
			["Salmonella",0.1, 65.0, 40.0, 1], # [name, next_spawn_time, hp,
											# movement_speed, track]
			["Salmonella",0.1, 65.0, 40.0, 2],
			["Salmonella",0.8, 65.0, 40.0, 3],
			["Salmonella",0.1, 65.0, 40.0, 1],
			...
			["Salmonella",0.1, 65.0, 40.0, 2],
			["Salmonella",1.0, 65.0, 40.0, 3],
			["Salmonella",0.1, 65.0, 40.0, 3],
			["Influenzavirus",0.1, 90.0, 29.0, 2],
			["Influenzavirus",2.0, 90.0, 29.0, 3],
			["Influenzavirus",2.0, 90.0, 29.0, 1],
			["Influenzavirus",0.8, 90.0, 29.0, 2]
			],
		"8":[
			["Salmonella",0.8, 65.0, 75.0, 1], # [name, next_spawn_time, hp,
											# movement_speed, track]

			["Salmonella",0.8, 65.0, 75.0, 1],
			["Salmonella",0.8, 65.0, 75.0, 1],
			["Salmonella",0.8, 65.0, 75.0, 1],
			["Salmonella",0.8, 65.0, 75.0, 1],
			["Salmonella",0.8, 65.0, 75.0, 1],
